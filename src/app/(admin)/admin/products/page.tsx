...
import { Plus, Search, Filter, Edit2, Trash2, Gem, X, Upload } from "lucide-react";

export default function ProductsPage() {
  const { products, addProduct, updateProduct, deleteProduct, setProducts, syncWithInitial } = useProductStore();
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 md:mb-8 pt-4 md:pt-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <button 
            ...
            className="flex items-center gap-1.5 bg-white border border-red-100 text-red-500 text-xs px-3 py-2 rounded-full hover:bg-red-50 transition-colors"
          >
            <Trash2 size={13} />
            ...
            <div className="p-6 overflow-y-auto space-y-6 flex-1">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-xs font-semibold uppercase tracking-wider text-[#555] mb-2">Main Image</label>
                    {formData.image ? (
