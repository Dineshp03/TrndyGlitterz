          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 md:mb-16 gap-6 md:gap-8 border-b border-obsidian/10 pb-6 md:pb-8">
            <div>
              ...
              <div className="flex items-center gap-4 mt-4">
                <p className="text-xs md:text-sm text-obsidian/60 font-sans tracking-widest uppercase">
                  Explore Our Complete Range
                </p>
                <div className="h-px w-8 bg-obsidian/10"></div>
                <button 
                  onClick={() => setShowImportedOnly(!showImportedOnly)}
                  className={`text-[10px] px-3 py-1 rounded-full border transition-all uppercase tracking-widest ${
                    showImportedOnly 
                    ? "bg-dustyrose text-alabaster border-dustyrose" 
                    : "bg-transparent text-obsidian/40 border-obsidian/10 hover:border-obsidian/30"
                  }`}
                >
                  {showImportedOnly ? "Showing Imported Only" : "Filter: Imported"}
                </button>
              </div>
            </div>
            <p className="text-[10px] md:text-xs font-mono text-obsidian/40 uppercase tracking-widest">
              {filteredProducts.length} ITEMS TOTAL
            </p>
          </div>

          <ProductSlider products={sortedProducts} />
        </div>
      </section>
