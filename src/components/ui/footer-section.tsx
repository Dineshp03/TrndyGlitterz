  ...
  return (
    <footer className="relative overflow-hidden w-full h-full">
      ...
      <div className="container mx-auto px-6 py-16 md:px-12 lg:px-16 relative z-10">
        ...
        {/* ── Bottom bar ──────────────────────────────────── */}
        <div className="mt-16 flex flex-col items-center justify-between gap-6 border-t border-obsidian/10 pt-8 text-center md:flex-row md:text-left">
          <div className="flex flex-col items-center md:items-start gap-2">
            <p className="text-[10px] sm:text-[11px] font-sans uppercase tracking-[0.15em] text-obsidian/40">
              &copy; {new Date().getFullYear()} TRENDY GLITTERZ. All rights reserved.
            </p>
            <p className="text-[10px] sm:text-[11px] font-sans uppercase tracking-[0.15em] text-obsidian/40 flex flex-wrap justify-center md:justify-start items-center gap-1.5">
              <span>Designed & Built by Dinesh</span>
              <span className="opacity-50">|</span>
              <a href="https://dinzi.dev" target="_blank" rel="noopener noreferrer" className="text-obsidian/70 hover:text-dustyrose transition-colors font-medium border-b border-transparent hover:border-dustyrose/50">DINZI.dev</a>
            </p>
          </div>
          <nav className="flex flex-wrap justify-center md:justify-end gap-x-6 gap-y-3 text-[10px] sm:text-[11px] font-sans uppercase tracking-[0.1em] text-obsidian/40">
